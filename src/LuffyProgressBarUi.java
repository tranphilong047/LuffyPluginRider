...
public class LuffyProgressBarUi extends BasicProgressBarUI {
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LuffyIcons.RLUFFY_ICON.paintIcon(progressBar, g, offset2 - JBUI.scale(3), -JBUI.scale(-2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        LuffyIcons.LUFFY_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
        g2.translate(0, -(c.getHeight() - h)/2);
